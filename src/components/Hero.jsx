...
const Hero = () => {
  ...
  return (
    <div
        ...
        className={`h-[1000px] flex justify-center items-center scale-[1] `}
      >
        {/* <img src={assets.solo} alt="" className="absolute -z-10 h-auto"/> */}
          <div className=" w-full h-full text-9xl  bg-gradient-to-r from-black to-transparent ">
            <div className="container max-w-13/14 mx-auto">
              <div>
                {imageIndex === 1 ? <img
                  src={assets.qwerty}
                  alt="solotext"
                  className="mt-[150px] "
                /> : <img src={assets.retext} alt="rezero" className="mt-[150px] w-[450px]"/>}
              </div>
