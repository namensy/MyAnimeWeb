...
const Allmovies: React.FC = () => {
  ...
  return (
    <section className="w-full h-[600px] relativ mt-11 ">
      <div
        className={`absolute left-0 bottom-82 md:bottom-51 lg:bottom-21 cursor-pointer z-10 md:py-28 lg:py-43 lg:px-3 bg-gradient-to-r from-[#00000088] from-100% to-transparent ${currentIndex === 0 ? 'hidden' : ''}`}
      ...
      >
        <svg
          ...
          className="lucide lucide-chevron-left size-8 text-neutral-300 cursor-pointer"
        >
          <path d="m15 18-6-6 6-6"></path>
        </svg>
      </div>
      <div
        className={`absolute right-0 bottom-82 md:bottom-51 lg:bottom-21 cursor-pointer z-10 md:py-28 lg:py-43 lg:px-3 bg-gradient-to-r from-[#00000088] from-100% to-transparent ${currentIndex === 18 ? 'hidden' : ''}`}
      ...
      >
        <svg
          ...
          strokeLinecap="round"
          strokeLinejoin="round"
          className="lucide lucide-chevron-right size-8 text-neutral-300 cursor-pointer"
        >
            ...
            {loading ? (
              ...
              animeList?.map((items) => (
                <Link
                  ...
                  className="w-full h-auto relative rounded-sm mt-5 "
                >
                  <div className="w-full aspect-[2/3] hover:bg-opacity-75 transition-all duration-300 ease-in-out">
                    <img
                      ...
                      decoding="async"
                      loading="lazy"
                      className="block w-full h-full mx-auto rounded-sm object-cover"
                    />
                  </div>
                  <p className="line-clamp-1 w-full text-white whitespace-normal mt-2 text-sm">
                    {items.title}
                  </p>
                    ...
                    <div className="absolute bottom-4 left-4 flex gap-2 mb-4">
                      <div className="relative group">
                        <svg
                          ...
                          strokeLinecap="round"
                          strokeLinejoin="round"
                          className="lucide lucide-play mr-2 h-5 w-5 text-orange-500 text-xl"
                        >
                      ...
                      <div className="relative group">
                        <svg
                          ...
                          strokeLinecap="round"
                          strokeLinejoin="round"
                          className="lucide lucide-bookmark h-5 w-5 text-orange-500 text-xl"
                        >
