...
const Allmovies: React.FC = () => {
  ...
  return (
    <section className='w-full h-full relative'>
      ...
      <div className="container w-11/12 mt-[100px] absolute left-4 sm:left-8 lg:left-12 xl:left-16 2xl:left-20 ">
        ...
        <div className="w-full h-full whitespace-nowrap transition-transform duration-1000 ease-in-out " style={{ transform: `translateX(-${currentIndex * (100 / 6)}%)` }}  >
          {loading ? (
            ...
            animeList?.map((items) => (
              <div key={`${items.mal_id}-${uuid()}`} className="w-2/6 lg:w-1/6 h-full relative py-4 rounded-sm inline-block mr-6 mt-5">
